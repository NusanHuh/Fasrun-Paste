<main class="font-sans w-full h-screen overflow-x-hidden overflow-y-hidden grid grid-cols-2 max-sm:grid-cols-1 max-sm:overflow-y-auto max-sm:h-fit">
            ...
            <g style="order: -1;">
                ...
                <defs>
                    <linearGradient y2="100%" x2="10%" y1="0%" x1="0%" id="gradiente">
                        <stop style="stop-color: #1f883d;stop-opacity:1" offset="20%"></stop>
                ...
                <defs>
                    <linearGradient y2="100%" x2="0%" y1="-17%" x1="10%" id="gradiente2">
                        <stop style="stop-color: #1f883d00;stop-opacity:1" offset="20%"></stop>
                        <stop
                            style="stop-color:#1f883d54;stop-opacity:1"
                            offset="100%"
                            id="animatedStop"
                        ></stop>
                    </linearGradient>
    ...
    <div class="scrolledit w-full h-full bg-[#ffffff] flex flex-col px-25 py-17.5 overflow-auto relative z-100 max-sm:overflow-hidden max-sm:px-7.5 max-sm:py-7.5">
        ...
        <div class="w-ful h-fit flex flex-row items-center justify-center mt-5 gap-1.75">
            <hr class="w-full h-px border border-[#d5dce3]">
            <p class="text-[#1f2328] text-[13px] font-semibold">Atau</p>
            <hr class="w-full h-px border border-[#d5dce3]">
        </div>
